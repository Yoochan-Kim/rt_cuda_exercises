...
EXPECTED_OUTPUT = """Stage 10 reduction matches reference ✅"""

STAGE_INFO = StageInfo(
    stage_id="10",
    exercise_src=ROOT / "exercises" / "stage10" / "main.cu",
    answer_src=ROOT / "answers" / "stage10" / "main.cu",
    normalizer=_normalize,
    expected_output=EXPECTED_OUTPUT,
    skip_cpu_reference_stage_id="07",
)
